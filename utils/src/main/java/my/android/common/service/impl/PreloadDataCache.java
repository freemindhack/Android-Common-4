...
import my.android.common.utils.ListUtils;
import my.android.common.utils.ObjectUtils;
import my.android.common.utils.SerializeUtils;
 ...
 * <li>{@link #setOnGetDataListener(my.android.common.service.impl.PreloadDataCache.OnGetDataListener)} set how to get data, this cache will get data and preload data
 * by it</li>
...
public class PreloadDataCache<K, V> extends SimpleCache<K, V> {
     ...
     * @see my.android.common.service.impl.PreloadDataCache#get(Object)
     */
     ...
     * <li>call {@link my.android.common.service.impl.PreloadDataCache.OnGetDataListener#onGetData(Object)} to get data and wait for it finish</li>
     * </ul>
     * 
     * @param key
     * @return element if this cache contains the specified key, else get data realtime and wait for it
