...
import my.android.common.service.Cache;
import my.android.common.service.CacheFullRemoveType;
import my.android.common.utils.MapUtils;
 ...
 * <li>{@link #saveCache(String, my.android.common.service.impl.SimpleCache)} save cache to file</li>
 * </ul>
 * <ul>
...
public class SimpleCache<K, V> implements Cache<K, V>, Serializable {
     ...
     * @see my.android.common.service.impl.SimpleCache#put(Object, CacheObject)
     */
    @Override
     ...
     * @param key
     * @return
     * @see my.android.common.service.impl.SimpleCache#isExpired(CacheObject)
     */
