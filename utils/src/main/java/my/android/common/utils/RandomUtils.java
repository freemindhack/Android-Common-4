...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see my.android.common.utils.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link my.android.common.utils.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
