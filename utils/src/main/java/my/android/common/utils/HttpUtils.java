 ...
 * <li>{@link #httpGet(HttpRequest, my.android.common.utils.HttpUtils.HttpListener)} http get asynchronous</li>
 * <li>{@link #httpGet(String, my.android.common.utils.HttpUtils.HttpListener)} http get asynchronous</li>
 * </ul>
 * <ul>
...
public class HttpUtils {
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see my.android.common.utils.HttpUtils#httpGet(HttpRequest)
     */
     ...
     * @param httpUrl
     * @return the response of the url, if null represents http error
     * @see my.android.common.utils.HttpUtils#httpPost(HttpRequest)
     */
     ...
     *        {@link my.android.common.utils.HttpUtils#joinParas(java.util.Map)}
     * @return the content of the url, if null represents http error
     * @see my.android.common.utils.HttpUtils#httpPost(HttpRequest)
     */
