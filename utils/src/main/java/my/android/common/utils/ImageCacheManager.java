...
import my.android.common.service.impl.FileNameRuleImageUrl;
import my.android.common.service.impl.ImageCache;
import my.android.common.service.impl.ImageSDCardCache;
import my.android.common.service.impl.RemoveTypeLastUsedTimeFirst;
import my.android.common.service.impl.ImageSDCardCache.OnImageSDCallbackListener;
import my.android.common.service.impl.ImageMemoryCache.OnImageCallbackListener;
import my.android.common.service.impl.PreloadDataCache.OnGetDataListener;
            ...
            public void onGetSuccess(String imageUrl, Bitmap loadedImage, View view,
                ...
                if (view != null && loadedImage != null) {
                    if (view instanceof ImageView) {
                        ...
                        Log.e(TAG, "View is not instance of ImageView, " +
                                "you need to setOnImageCallbackListener() by your self");
                    }
                }
            }
        ...
        OnImageSDCallbackListener imageCallBack = new OnImageSDCallbackListener() {
            ...
            public void onGetSuccess(String imageUrl, String imagePath, View view,
                ...
                if (view != null && view instanceof ImageView) {
                    ...
                    Log.e(TAG, "View is not instance of ImageView, " +
                            "you need to setOnImageSDCallbackListener() by your self");
                }
            }
