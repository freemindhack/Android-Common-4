package my.android.common.view;
...
import my.android.common.utils.R;
 ...
 * before</li>
 * <li>{@link #setOnDropDownListener(my.android.common.view.DropDownListView.OnDropDownListener)} set listener which will be excuted when drop down, but you
